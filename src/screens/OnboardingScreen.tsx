...
const onboardingSteps = [
  ...
  },
  {
    ...
    description: "monVOX utilise l'IA pour vous aider, tout en gardant vos informations sécurisées sur votre appareil.",
    icon: "bulb" as const
  },
  {
    title: "C'est parti !",
...
export const OnboardingScreen: React.FC = () => {
  ...
  const setupBiometric = async () => {
    ...
    try {
      ...
      const result = await authService.authenticate("Configurer l'authentification pour monVOX");
